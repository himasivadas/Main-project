...
$query=mysqli_query($con,"SELECT * FROM users WHERE email='adarsh@gmail.com' and password='123123'");
...
if($utype=='stock')
{
	header("stock/dash.php");
	/*$extra2="stock/dash.php";
...
?>
		...
		<div class="radio outer-xs">
	  	...
	  	<button type="submit" class="btn-upper btn btn-primary checkout-page-button" name="login1">Login
	  	</button>
...
$_SESSION['username']=$num['name'];
	...
	{
		header('location:dboy/dashed.php');
	}
	else
	{
...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" id="phn" name="contactno" maxlength="10" required onchange="Validat();">
