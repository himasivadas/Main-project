...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="product reviews.php" class="lnk">(<?php echo htmlentities($num);?> Reviews)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
								                <div class="arrows">
								                  <div class=""><span class="ir"><i class=""></i></span></div>
								                  <div class=""><span class="ir"><i class=""></i></span></div>
								                </div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Packing</td>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<input type="text" class="form-control txt" id="nme" placeholder="" name="name"  required onchange="Validate();"  >
...
document.getElementById('msg1').innerHTML=" ";
    return true;
																...
																<div class="form-group">
																	...
																	<input type="text" class="form-control txt" id="Smmy" placeholder="" name="summary" required="required">
																</div><!-- /.form-group -->
															</div>
